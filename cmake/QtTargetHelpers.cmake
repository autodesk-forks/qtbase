...
function(qt_set_target_info_properties target)
    ...
    if(NOT arg_TARGET_VERSION)
        # Check if PROJECT_VERSION already has 4 parts (e.g., "6.8.3.1")
        # If so, use it directly. Otherwise, append ".0" to make it 4 parts.
        string(REPLACE "." ";" _version_list "${PROJECT_VERSION}")
        list(LENGTH _version_list _version_parts)
        if(_version_parts GREATER_EQUAL 4)
